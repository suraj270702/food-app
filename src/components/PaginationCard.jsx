...
import { setPageValue, increment, decrement } from "../features/page/pageSlice";
  ...
  for (let i = startButton; i <= endButton; i++) {
    buttons.push(
      <button
        ...
        className={`relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 ${
